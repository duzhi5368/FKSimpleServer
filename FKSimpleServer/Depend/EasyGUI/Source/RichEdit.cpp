...
//------------------------------------------------------------------------
BOOL CEGRichEdit::Create( HWND hParents, DWORD dwStyle, int x, int y, int width, int height, TCHAR * pText )
{
...
//------------------------------------------------------------------------
BOOL CEGRichEdit::printf(DWORD dwColor, TCHAR * pBuff, ...)
{
	TCHAR szBuff[4096];
...
//------------------------------------------------------------------------
BOOL CEGRichEdit::AddLine(DWORD dwColor, TCHAR * pLine)
{
